...
% Initialize start scenario
            ...
            patch([Parked_Car1x1 Parked_Car1x2 Parked_Car1x3 Parked_Car1x4],[Parked_Car1y1 Parked_Car1y2 Parked_Car1y3 Parked_Car1y4],[0 1 1]);
            patch([Parked_Car3x1 Parked_Car3x2 Parked_Car3x3 Parked_Car3x4],[Parked_Car3y1 Parked_Car3y2 Parked_Car3y3 Parked_Car3y4],[1 1 0]);
            title(" ");
            text(Parked_Car1x2,Parked_Car1y2+5,"Car 1");
            text(Parked_Car2x2,Parked_Car2y2+5,"Car 2");
            text(Parked_Car3x2,Parked_Car3y2+5,"Car 3");
            text(Parked_Car3x2,Parked_Car3y2+60,"The Parking Process of Ackerman's Vehicle",'Color','r','FontSize',14);
